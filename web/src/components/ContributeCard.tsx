 ...
 * page rather than buried in a footer. This card asks for evidence and source
 * review only; the single low-emphasis financial-support link stays in the
 * product footer. The wording stays inside the evidence rules - contributions
 * are invited, publication is never promised.
 */
