...
- Citation audit over 94 cited facts: **0** hard failures (not-found, wrong-page, bad-page-number). Binding tiers — verbatim 42, row-bound 30, normalized 12, unverifiable 6, numbers-only 3, alnum 1.
